...
def round_1 ():   
    ...
    while True:
        ...
        if option_1.upper() == "A":
               ...
               """)
                ...
                if t_bonds_option_1.upper()== "A":
                    ...
                    first_interest = (3/12) * int(investment_fund_option_1) * three_tbonds_rate
                    ...
                    first_interest = (6/12) * int(investment_fund_option_1) *six_tbonds_rate
        ...
        if option_1.upper() == "B":
            ...
            if SP_guess == 1:
                first_interest= three_tbonds_rate * investment_fund_option_1
            elif SP_guess == 2:
                first_interest = six_tbonds_rate * investment_fund_option_1
                
            elif SP_guess == 3:
                first_interest = three_years_bonds_rate * investment_fund_option_1
            break
    ...
    while True:
        ...
        if option_2.upper() == "A":
               ...
               """)
                ...
                if t_bonds_option_2.upper()== "A":
                    ...
                    second_interest = (6/12) * int(investment_fund_option_2) *six_tbonds_rate
        ...
        if option_2.upper() == "B":
            ...
            second_interest= three_tbonds_rate
            break
    ...
    player_investment_value = investment_fund_option_1 + balance_after_option_1 +investment_fund_option_2 + first_interest + second_interest
...
while True:
    ...
    if option_3.upper() == "A":
           ...
           """)
            ...
            if t_bonds_option_3.upper()== "A":
                ...
                third_interest = (3/12) * int(investment_fund_option_3) * three_tbonds_rate
                ...
                third_interest = (6/12) * int(investment_fund_option_3) *six_tbonds_rate
                ...
                third_interest = int(investment_fund_option_3) * twelve_tbonds_rate
    ...
    if option_3.upper() == "B":
        ...
        if bonds_option_3.upper()== "A":
            ...
            third_interest = int(investment_fund_option_3) * two_years_bonds_rate
            ...
            third_interest = int(investment_fund_option_3) * three_years_bonds_rate
            ...
            third_interest = int(investment_fund_option_3) * five_years_bonds_rate
        ...
        SP_guess = random.randint(1,3)
        if SP_guess == 1:
            third_interest = three_tbonds_rate * investment_fund_option_3
        elif SP_guess == 2:
            third_interest = three_tbonds_rate * investment_fund_option_3
            
        elif SP_guess == 3:
            third_interest = six_tbonds_rate * investment_fund_option_3
        break
...
while True:
    ...
    if option_4.upper() == "B":
        ...
        SP_guess = random.randint(1,3)
        if SP_guess == 1:
            fourth_interest= -three_tbonds_rate * investment_fund_option_1
        elif SP_guess == 2:
            fourth_interest = three_tbonds_rate * investment_fund_option_1
            
        elif SP_guess == 3:
            fourth_interest = six_tbonds_rate * investment_fund_option_1
        break
...
while True:
    ...
    if option_5.upper() == "A":
           ...
           """)
            ...
            if t_bonds_option_5.upper()== "A":
                ...
                fifth_interest = (3/12) * int(investment_fund_option_5) * three_tbonds_rate
                ...
                fifth_interest = (6/12) * int(investment_fund_option_5) *six_tbonds_rate
                ...
                fifth_interest = int(investment_fund_option_5) * twelve_tbonds_rate
    ...
    if option_5.upper() == "B":
        ...
        if bonds_option_5.upper()== "A":
            ...
            fifth_interest = int(investment_fund_option_5) * two_years_bonds_rate
            ...
            fifth_interest = int(investment_fund_option_5) * three_years_bonds_rate
            ...
            fifth_interest = int(investment_fund_option_5) * five_years_bonds_rate
        ...
        SP_guess = random.randint(1,3)
        if SP_guess == 1:
             fifth_interest = three_tbonds_rate * investment_fund_option_5
        elif SP_guess == 2:
             fifth_interest = three_tbonds_rate * investment_fund_option_5
        ...
        fifth_interest_interest = three_tbonds_rate * investment_fund_option_3
...
while True:
    ...
    if option_6.upper() == "A":
           ...
           """)
            ...
            if t_bonds_option_6.upper()== "A":
                ...
                final_interest = (6/12) * int(investment_fund_option_6) *six_tbonds_rate
                ...
                final_interest = int(investment_fund_option_6) * twelve_tbonds_rate
    ...
    if option_6.upper() == "B":
        ...
        if bonds_option_6.upper()== "A":
            ...
            final_interest = int(investment_fund_option_6) * two_years_bonds_rate
            ...
            final_interest = int(investment_fund_option_6) * three_years_bonds_rate
            ...
            fourth_interest = int(investment_fund_option_6) * five_years_bonds_rate
        ...
        SP_guess = random.randint(1,3)
        if SP_guess == 1:
            final_interest=  three_tbonds_rate * investment_fund_option_6
        elif SP_guess == 2:
            final_interest = three_tbonds_rate * investment_fund_option_6
