...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 19:45:11 2020
...
for domain in housing.loc[:,'email_domain']:
...
x_variables_2 = [ 'TOTAL_MEALS_ORDERED','UNIQUE_MEALS_PURCH','CONTACTS_W_CUSTOMER_SERVICE',
                 ...
                 'OUT_CONTACTS_W_CUSTOMER_SERVICE','OUT_TOTAL_PHOTOS_VIEWED','OUT_AVG_CLICKS_PER_VISIT','OUT_WEEKLY_PLAN']
...
#Of the entire test set, 80% of the customer’s preferred term deposits that were promoted.
