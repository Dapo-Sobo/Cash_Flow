...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 02:01:20 2019
...
credit at the end of the game by investing in various asset classes varying risk and return.
random elements defined as "economic variables" will determine your path through the game.
All the concepts have been duly explained so no prior expertise is needed to play the game.

There are 3 stages and 2 rounds in each stage. The results at the end of stage 3 is cummulative.
...
def stage_1 ():
    ...
    global investment_fund_option_4end
    global investment_fund_option_5
    global investment_fund_option_5end
    ...
    global three_tbonds_rate_2
    global three_tbonds_rate_3
    global three_tbonds_rate_4
    global three_tbonds_rate_5
    global three_tbonds_rate_6
    global six_tbonds_rate
    global six_tbonds_rate_2
    global six_tbonds_rate_3
    global six_tbonds_rate_4
    global six_tbonds_rate_5
    global six_tbonds_rate_6
    global twelve_tbonds_rate
    global two_years_bonds_rate
    global two_years_bonds_rate_2
    global two_years_bonds_rate_3
    global two_years_bonds_rate_4
    global two_years_bonds_rate_5
    global two_years_bonds_rate_6
    global three_years_bonds_rate
    global three_years_bonds_rate_2
    global three_years_bonds_rate_3
    global three_years_bonds_rate_4
    global three_years_bonds_rate_5
    global three_years_bonds_rate_6
    global five_years_bonds_rate
    global five_years_bonds_rate_2
    global five_years_bonds_rate_3
    global five_years_bonds_rate_4
    global five_years_bonds_rate_5
    global five_years_bonds_rate_6
    ...
    print("""
         ...
         The goal of the game is to increase the value of your investment and make enough money to pay off your credit at the end of the game by investing in various asset classes.
         """ )
    ...
    print(f""" 
          ...
          Congratulations!! The bank just approved $10,000 runnung at an initial rate of 4.00% then float in the final 2 stages to a max of 7% depending on certain economic variables. You can invest in any asset class like stocks, private equity funds, treasury bonds, and bonds or any combination that matches your preference
          """)
    ...
    while True:
        ...
        try:
            ...
            if int(float((investment_fund_option_1))) >= investment_fund:
                print (investment_fund_option_1)
    ...
    while True:
        ...
        if option_1.upper() == "A":
               ...
               X: 3 months treasury bonds @ {three_tbonds_rate}
               Y: 6 months treasury bonds @ {six_tbonds_rate}
               Z: 12 month treasury bonds @ {twelve_tbonds_rate}
               """)
                
                if t_bonds_option_1.upper()== "X":
                ...
                if t_bonds_option_1.upper() == "Z":
                    ...
                    print("Error!! Please select option X, Y or Z")
        ...
        if option_1.upper() == "B":
            ...
            bonds_option_1 = input (f"""
               ...
               Would you like to invest in 
               X: 2 years bonds @ {two_years_bonds_rate}
               Y: 3 years bonds @ {three_years_bonds_rate}
               Z: 5 years bonds @ {five_years_bonds_rate}
               """)
        
            if bonds_option_1.upper()== "X":
    ...
    if economic_variable == 1: 
        ...
        if option_1.upper() == "A" or option_1.upper() == "B":
        ...
        if option_1.upper() == "C" or option_1.upper() == "D":
    ...
    while True:
        ...
        if option_2.upper() == "A":
               ...
               """)
                ...
                elif t_bonds_option_2.upper() == "Z":
            
                    second_interest = int(investment_fund_option_2) * twelve_tbonds_rate
        ...
        if option_2.upper() == "B":
            ...
            elif bonds_option_2.upper() == "Y":
            
                second_interest = int(investment_fund_option_2) * three_years_bonds_rate
            
                print(f'Your expected interest is is ${second_interest}. All things being equal. Good luck  ')
                break
            
            elif bonds_option_2.upper() == "Z":
            ...
            SP_guess = random.randint(1,3)
            if SP_guess == 1:
                second_interest= three_tbonds_rate * int(investment_fund_option_2)
                print(f'Your expected profit is ${second_interest} . All things being equal. Good luck ')
            if SP_guess == 2:
                second_interest = three_years_bonds_rate * int(investment_fund_option_2)
                print(f'Your expected profit is ${second_interest} . All things being equal. Good luck ')
                
            if SP_guess == 3:
                second_interest = six_tbonds_rate * int(investment_fund_option_2)
                print(f'Your expected profit is ${second_interest} . All things being equal. Good luck ')
            break
...
{'-'* 80}     
    ...
    total_loan_repayment = int(investment_fund) * 1.04
    ...
    print( f""" 
          {'-'* 50} 
    Your investment value is ${player_investment_value}"
          {'-'* 50} 
          """)
...
def stage_2(stage_1):   
    ...
    if economic_variable == 1: 
        ...
        if option_2.upper() == "A" or option_2.upper() == "B":
        ...
        if option_2.upper() == "C" or option_2.upper() == "D":
            
            if stocks_rise_fall == 1:
                
                investment_fund_option_2end = int(investment_fund_option_2) * 1.20
            ...
            if stocks_rise_fall == 0:
                ...
                investment_fund_option_2end = int(investment_fund_option_2) * 0.95
    ...
    while True:
        ...
        try:
            ...
            investment_fund_option_3 = input(f'How much would you like to invest? Please enter a figure less han ${player_investment_value}: ') 
      
            investment_fund_option_3 = int(float(f"{investment_fund_option_3}"))
        
            if int(float((investment_fund_option_3))) >= player_investment_value:
                print (investment_fund_option_3)
    ...
    while True:
        ...
        if option_3.upper() == "A":
               ...
               Would you like to invest in 
               X: 3 months treasury bonds @ {three_tbonds_rate_2}
               Y: 6 months treasury bonds @ {six_tbonds_rate_2}
               Z: 12 month treasury bonds @ {twelve_tbonds_rate_2}
               """)
                
                if t_bonds_option_3.upper()== "X":
        ...
        if option_3.upper() == "B":
            ...
            bonds_option_3 = input (f"""
               ...
               Would you like to invest in 
               X: 2 years bonds @ {two_years_bonds_rate_2}
               Y: 3 years bonds @ {three_years_bonds_rate_2}
               Z: 5 years bonds @ {five_years_bonds_rate_2}
               """)
        
            if bonds_option_3.upper()== "X":
            ...
            SP_guess = random.randint(1,3)
            if SP_guess == 1:
                third_interest = three_tbonds_rate_2 * int(investment_fund_option_3)
            if SP_guess == 2:
                third_interest = three_tbonds_rate_2 *  int(investment_fund_option_3)
                
            if SP_guess == 3:
                third_interest = three_tbonds_rate_2 * 2 * int(investment_fund_option_3)
            break
...
ROUND3  |       ${investment_fund_option_3}         {third_interest}        {total_value_round_3a}
...
{'-'* 80}     
    ...
    if economic_variable == 1: 
        ...
        if option_3.upper() == "A" or option_3.upper() == "B":
        ...
        if option_3.upper() == "C" or option_3.upper() ==  "D":
            
            if stocks_rise_fall == 1:
                
                investment_fund_option_3end = int(investment_fund_option_3) * 1.20
            ...
            if stocks_rise_fall == 0:
                ...
                investment_fund_option_3end = int(investment_fund_option_3) * 0.95
    ...
    if economic_variable == 7: 
        ...
        if option_3.upper() == "C" or option_3.upper() ==  "D":
            ...
            investment_fund_option_3end = int(investment_fund_option_3) * 1.19
            ...
            print(f"""
                  Invested amount in stocks or private equity fund has increased by 19% to 
                  {investment_fund_option_3end}    
                  """)
    ...
    if economic_variable == 9: 
        ...
        three_tbonds_rate_3 = three_tbonds_rate
        
        six_tbonds_rate_3 = six_tbonds_rate 
            
        twelve_tbonds_rate_3 = twelve_tbonds_rate 
            
        two_years_bonds_rate_3 = two_years_bonds_rate
            
        three_years_bonds_rate_3 = three_years_bonds_rate
            
        five_years_bonds_rate_3 = five_years_bonds_rate
...
{'-'* 80}     
    ...
    while True:
        ...
        if option_4.upper() == "A":
               ...
               Would you like to invest in 
               X: 3 months treasury bonds @ {three_tbonds_rate_3}
               Y: 6 months treasury bonds @ {six_tbonds_rate_3}
               Z: 12 month treasury bonds @ {twelve_tbonds_rate_3}
               """)
                
                if t_bonds_option_4.upper()== "X":
        ...
        if option_4.upper() == "B":
            ...
            bonds_option_4 = input (f"""
               ...
               Would you like to invest in 
               X: 2 years bonds @ {two_years_bonds_rate_3}
               Y: 3 years bonds @ {three_years_bonds_rate_3}
               Z: 5 years bonds @ {five_years_bonds_rate_3}
               """)
        
            if bonds_option_4.upper()== "X":
            ...
            elif bonds_option_4.upper() == "Y":
            
                fourth_interest = int(investment_fund_option_4) * three_years_bonds_rate_3
            
                print(f'Your expected interest per annum is is ${fourth_interest} for the next 3 years. All things being equal.  ')
                break
            
            elif bonds_option_4.upper() == "Z":
            
                fourth_interest = int(investment_fund_option_4) * five_years_bonds_rate
            ...
            SP_guess = random.randint(1,3)
            if SP_guess == 1:
                fourth_interest= -three_tbonds_rate_3 * int(investment_fund_option_1)
            if SP_guess == 2:
                fourth_interest = three_tbonds_rate_3 * int(investment_fund_option_1)
                
            if SP_guess == 3:
                fourth_interest = six_tbonds_rate_3 * int(investment_fund_option_1)
            break
    ...
    total_loan_repayment = int(investment_fund) * 1.04 + (player_investment_value * 1.07)
    
    print( f""" 
          {'-'* 50} 
    Total loan repayment amount is ${total_loan_repayment}
          {'-'* 50} 
          """)
    
    player_investment_value_2 = total_value_round_1 + total_value_round_2 + total_value_round_3 + total_value_round_4 
    
    print( f""" 
          {'-'* 50} 
    Your total value is ${player_investment_value_2}"
          {'-'* 50} 
          """)
    ...
    if player_investment_value_2 < total_loan_repayment:
        ...
        difference = total_loan_repayment - player_investment_value_2
...
def stage_3(stage_1,stage_2): 
    ...
    print (f"""" Welcome to the final stage!!! Congrats you made it
    ...
    if economic_variable == 1: 
        ...
        if option_4.upper() == "A" or option_4.upper() == "B":
        ...
        if option_4.upper() == "C" or option_4.upper() ==  "D":
            
            if stocks_rise_fall == 1:
                
                investment_fund_option_4end = int(investment_fund_option_4) * 1.20
            ...
            if stocks_rise_fall == 0:
                ...
                investment_fund_option_4end = int(investment_fund_option_4) * 0.95
    ...
    if economic_variable == 5: 
        ...
        if option_4.upper() == "C" or option_4.upper() == "D":
                ...
                investment_fund_option_4end = int(investment_fund_option_4) * 1.15
    ...
    if economic_variable == 7: 
        ...
        if option_4.upper() == "A" or option_3.upper() == "B":
    ...
    investment_fund_option_5 = input(f'How much would you like to invest from ${player_investment_value_2},your new approved loan amount: ')
    
    while True:
    
        try:
    
            investment_fund_option_5 = input(f'How much would you like to invest? Please enter a figure less than ${player_investment_value_2},your new approved loan amount: ') 
      
            investment_fund_option_5 = int(float(f"{investment_fund_option_5}"))
        
            if int(float((investment_fund_option_5))) >= player_investment_value_2:
                print (investment_fund_option_5)
    ...
    while True:
        ...
        if option_5.upper() == "A":
               ...
               Would you like to invest in 
               X: 3 months treasury bonds @ {three_tbonds_rate_4}
               Y: 6 months treasury bonds @ {six_tbonds_rate_4}
               Z: 12 month treasury bonds @ {twelve_tbonds_rate_4}
               """)
                
                if t_bonds_option_5.upper()== "X":
        ...
        if option_5.upper() == "B":
            ...
            bonds_option_5 = input (f"""
               ...
               Would you like to invest in 
               X: 2 years bonds @ {two_years_bonds_rate_4}
               Y: 3 years bonds @ {three_years_bonds_rate_4}
               Z: 5 years bonds @ {five_years_bonds_rate_4}
               """)
        
            if bonds_option_5.upper()== "X":
            ...
            SP_guess = random.randint(1,3)
            if SP_guess == 1:
                fifth_interest = three_tbonds_rate_4 * int(investment_fund_option_5)
            if SP_guess == 2:
                fifth_interest = three_tbonds_rate_4 * int(investment_fund_option_5)
                
            if SP_guess == 3:
                fifth_interest = six_tbonds_rate_4 * int(investment_fund_option_5)
            break
...
{'-'* 80}     
    ...
    if economic_variable == 1: 
        ...
        if option_5.upper() == "A" or option_5.upper() == "B":
        ...
        if option_5.upper() == "C" or option_5.upper() == "D":
            
            if stocks_rise_fall == 1:
                
                investment_fund_option_5end = int(investment_fund_option_5) * 1.20
            ...
            if stocks_rise_fall == 0:
                ...
                investment_fund_option_5end = int(investment_fund_option_5) * 0.95
    ...
    if economic_variable == 8: 
        ...
        if option_5.upper() == "C" or option_5.upper() == "D":
            ...
            if stocks_rise_fall == 1:
                ...
                investment_fund_option_5end = int(investment_fund_option_5) * 1.15
    ...
    if economic_variable == 9: 
        ...
        three_tbonds_rate_5 = three_tbonds_rate 
        
        six_tbonds_rate_5 = six_tbonds_rate 
        
        twelve_tbonds_rate_5 = twelve_tbonds_rate 
        
        two_years_bonds_rate_5 = two_years_bonds_rate 
        
        three_years_bonds_rate_5 = three_years_bonds_rate 
        
        five_years_bonds_rate_5 = five_years_bonds_rate 
...
{'-'* 80}     
    ...
    while True:
        ...
        if option_6.upper() == "A":
               ...
               Would you like to invest in 
               X: 3 months treasury bonds @ {three_tbonds_rate_5}
               Y: 6 months treasury bonds @ {six_tbonds_rate_5}
               Z: 12 month treasury bonds @ {twelve_tbonds_rate_5}
               """)
                
                if t_bonds_option_6.upper()== "X":
        ...
        if option_6.upper() == "B":
            ...
            bonds_option_6 = input (f"""
               ...
               Would you like to invest in 
               X: 2 years bonds @ {two_years_bonds_rate_5}
               Y: 3 years bonds @ {three_years_bonds_rate_5}
               Z: 5 years bonds @ {five_years_bonds_rate_5}
               """)
        
            if bonds_option_6.upper()== "X":
            ...
            if SP_guess == 1:
                final_interest= -three_tbonds_rate_5 * int(investment_fund_option_6)
            ...
            final_interest = six_tbonds_rate_5 * int(investment_fund_option_6)
...
{'-'* 80}     
    ...
    total_loan_repayment = int(investment_fund) * 1.01 + (player_investment_value * 1.01) + (player_investment_value_2 * 1.01)
    ...
    player_investment_value_3 =  total_value_round_1 +total_value_round_2 +total_value_round_3+total_value_round_4 +total_value_round_5 +total_value_round_6 
   
    print( f""" 
         {'-'* 50} 
    Your total value is ${player_investment_value_3}"
          {'-'* 50} 
          """)
    
    if player_investment_value_3 <= total_loan_repayment:
        
        difference = total_loan_repayment - player_investment_value_3
