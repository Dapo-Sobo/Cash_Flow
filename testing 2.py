...
def stage_1 ():
    ...
    if economic_variable == 9: 
        ...
        investment_fund_option_1end = investment_fund_option_2
...
def stage_2(stage_1):   
    ...
    while True:
        ...
        ValueError
        investment_fund_option_3 = input(f'How much would you like to invest from ,your new approved loan amount: ')
        break
...
def stage_3(stage_1,stage_2): 
    ...
    while True:
        ...
        ValueError
        investment_fund_option_5 = input(f'How much would you like to invest from ,your new approved loan amount: ')
        break
    ...
    total_value_round_2 = investment_fund_option_2end + second_interest
    total_value_round_3 = investment_fund_option_3end + third_interest
    total_value_round_4 = investment_fund_option_4end + fouth_interest
