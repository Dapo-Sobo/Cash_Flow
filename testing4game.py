...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 00:55:23 2019
...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 22:19:36 2019
    ...
    while True:
        ...
        if option_3.upper() == "B":
            ...
            if SP_guess == 1:
                ...
                third_interest = six_tbonds_rate_2 * int(investment_fund_option_3)
            break
...
{'-'* 80}     
    ...
    if economic_variable == 2: 
        ...
        if option_3.upper() == "A" or "B":
            ...
            if stocks_rise_fall == 1:
                ...
                investment_fund_option_3end = int(investment_fund_option_2) * 1.20
                ...
                investment_fund_option_3end = int(investment_fund_option_2) * 0.95
    ...
    if economic_variable == 7: 
        ...
        if option_3.upper() == "A" or "B":
            ...
            investment_fund_option_3end = int(investment_fund_option_2) * 1.19
...
def stage_3(stage_1,stage_2): 
    ...
    while True:
        ...
        try:
            ...
            investment_fund_option_5 = input(f'How much would you like to invest? Please enter a figure less than ${player_investment_value_2}: ') 
    ...
    while True:
        ...
        if option_5.upper() == "B":
            ...
            SP_guess = random.randint(1,3)
            if SP_guess == 1:
                third_interest = three_tbonds_rate_4 * int(investment_fund_option_5)
            elif SP_guess == 2:
                third_interest = three_tbonds_rate_4 * int(investment_fund_option_5)
                
            elif SP_guess == 3:
                third_interest = six_tbonds_rate_4 * int(investment_fund_option_5)
            break
...
{'-'* 80}     
    ...
    while True:
        ...
        if option_6.upper() == "B":
            ...
            if SP_guess == 1:
                fourth_interest= -three_tbonds_rate_5 * int(investment_fund_option_6)
            ...
            fourth_interest = six_tbonds_rate_5 * int(investment_fund_option_6)
...
Stage   |       Investment_value                 Interest earned           Total value 
...
{'-'* 80}     
    ...
    total_loan_repayment = int(investment_fund) * 1.07 + (player_investment_value * 1.07) + (player_investment_value_2 * 1.10)
